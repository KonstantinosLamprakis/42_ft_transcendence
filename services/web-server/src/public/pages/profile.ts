                ...
                <div
                    ...
                    <div class="relative mb-4">
                        <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-32"
                            style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCwYCj6wqDqHNbqFV8In_Ml91-1EuZiuiB2OjM8FhoqHcxb8j1tn8zeoF2PktmP4hHktrWMxlPrYb6fi-R4qveDfCe6hNVsomFybi4q3BP26V4dJQu7hKGFIPJGUWfxvieDMQTocybKd33wBSpAX435pP-r_cT9MeMz5CUZD2ebJRF-zMlVpQusbbXsQyKdH3ymtU5TvjFHM_c5TvRcx-9HwN2ym9-ubjrraCPvF6h3JEGaKwCx2QFZC0nDFO-bCk8q1HDeEQCC2Q");'>
                        </div>
                        <button
                    ...
                    <h2 class="text-2xl font-bold text-[var(--text-primary)]">Alex Ryder</h2>
                    <p class="text-[var(--text-secondary)]">@alexryder</p>
                    <div class="mt-4 flex gap-4">
                        <div class="text-center">
                            <p class="text-xl font-bold text-[var(--text-primary)]">128</p>
                            <p class="text-sm text-[var(--text-secondary)]">Wins</p>
                        </div>
                        <div class="border-l border-[var(--border-color)]"></div>
                        <div class="text-center">
                            <p class="text-xl font-bold text-[var(--text-primary)]">42</p>
